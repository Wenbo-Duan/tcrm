...
path = 'C:\Climate_data\GFDL-ESM4 (USA)\SSP3_7.0_Daily_SLP'
file_list = ['psl_day_GFDL-ESM4_ssp370_r1i1p1f1_gr1_20310101-20410101_v20180701.nc', 
             'psl_day_GFDL-ESM4_ssp370_r1i1p1f1_gr1_20410101-20501231_v20180701.nc',
             'psl_day_GFDL-ESM4_ssp370_r1i1p1f1_gr1_20510101-20601231_v20180701.nc']

inputshape = (180, 288) # shape of data in projection files
...
path_his = 'C:\Climate_data\GFDL-ESM4 (USA)\historical_data_Daily_SLP'
file_his_list = ['psl_day_GFDL-ESM4_historical_r1i1p1f1_gr1_19700101-19891231_v20190726.nc',
                 'psl_day_GFDL-ESM4_historical_r1i1p1f1_gr1_19900101-20091231_v20190726.nc',
                 'psl_day_GFDL-ESM4_historical_r1i1p1f1_gr1_20100101-20141231_v20190726.nc']
...
ncobj_his_2 = nctools.ncLoadFile(os.path.join(path_his,file_his_list[1]))
data_his_2 = nctools.ncGetData(ncobj_his_2, 'psl')
data_his_lon = nctools.ncGetData(ncobj_his_2, 'lon')
data_his_lat = nctools.ncGetData(ncobj_his_2, 'lat')

ncobj_his_3 = nctools.ncLoadFile(os.path.join(path_his,file_his_list[2]))
data_his_3 = nctools.ncGetData(ncobj_his_2, 'psl')
data_his_lon = nctools.ncGetData(ncobj_his_2, 'lon')
data_his_lat = nctools.ncGetData(ncobj_his_2, 'lat')

his_1981_2010 = np.ones((30*365, inputshape[0],inputshape[1]))*-1
# insert data from first his dataset from 1981 to 1989
his_1981_2010[0 : (1990 - 1981) * 365,:,:] = data_his_1[(1981 - 1970) * 365 :,:,:]
# insert data from second his dataset from 1990 to 2009
his_1981_2010[(1990 - 1981) * 365:(2010 - 1981) * 365,:,:] = data_his_2[:,:,:]
# insert data from third his dataset for 2010
his_1981_2010[(2010 - 1981) * 365:,:,:] = data_his_3[:365,:,:]
...
# create NC file
fn = 'C:/tcrm/MSLP/Corrected.GFDL-ESM4.mslp.day.2031-2060.1981-2010.nc'
