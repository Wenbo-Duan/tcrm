...
class WindfieldAroundTrack(object):
    ...
    :param gustFactor: Conversion from 1-min mean to 3-sec gust wind speed,
                       for off-sea conditions. See WMO TD1555 (2010) for
                       details. used 1.28 according to ESDU curve - WD
    ...
    def __init__(self, track, profileType='powell', windFieldType='kepert',
                 ...
                 margin=2.0, resolution=0.05, gustFactor=1.28,
